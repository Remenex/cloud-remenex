      ...
      >
        <div className="relative aspect-video bg-muted overflow-hidden">
          ...
          <div
            ...
            className={`absolute inset-0 bg-foreground/20 cursor-pointer flex items-center justify-center transition-opacity duration-300 ${hovered ? "opacity-100" : "opacity-0"}`}
          >
